...
from .helpers_base import PerceiverResampler,AttentionSampler
...
class Flamingo_base(nn.Module):
    def __init__(
        ...
        self.perceiver = PerceiverResampler(dim=self.vis_dim,max_num_media=1)
        #self.attentionsampler = AttentionSampler(dim=self.vis_dim,depth=2)
        ...
        #self.attentionsampler._use_gradient_checkpointing = gradient_checkpointing
    ...
    def _encode_vision_x(self, vision_x: torch.Tensor):
        ...
        #attn_weights,vision_enhanced= self.attentionsampler(vision_x)
        
        #combined_x = self.perceiver(vision_enhanced)
        
        combined_x = self.perceiver(vision_x)
    ...
    def wrap_fsdp(self, wrapper_kwargs, device_id):
        ...
        with enable_wrap(wrapper_cls=FSDP, **wrapper_kwargs):
            ...
            #self.attentionsampler = wrap(wrap(self.attentionsampler))
