...
def fsdp_main(rank, world_size, args):
    ...
    #dataset loading 
    train_dataset_info = get_dataset_gaze_attention(tokenizer, clip_processor, 'train', rank, world_size,base_path='/home/pani3/dataset_singular_large')
    ...
    checkpoint_path = os.path.join("/home/pani3/gaze_model2_10.pth")
    if os.path.isfile(checkpoint_path):
        dist.barrier()
        resume_checkpoint=1
        start_epoch ,checkpoint = load_checkpoint_gaze("/home/pani3/gaze_model2_10.pth")
        if rank==0:
            model.load_state_dict(checkpoint['model_state_dict'],strict=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir",type=str,default="/home/pani3")
