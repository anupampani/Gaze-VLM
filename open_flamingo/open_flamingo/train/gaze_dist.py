...
def fsdp_main(rank, world_size, args):
    ...
    #training 
        ...
        # #basically this breaks it into patches and also does the linear projection
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_dir",type=str,default="insert path/open_flamingo/open_flamingo/models/gaze_attention")
