...
def fsdp_main(rank, world_size, args):
    ...
    total_scores = score_rouge(model,test_loader,tokenizer,rank)
    if rank==0:

        save_loss_to_file(total_scores,"insert path/open_flamingo/open_flamingo/models/review2/gaze_rogue.txt")
        print("over")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=str, default="1075", help="Distributed training port")
