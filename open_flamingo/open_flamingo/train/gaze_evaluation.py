...
def fsdp_main(rank, world_size, args):
    ...
    # test_dataset_info = get_dataset_gaze_attention(tokenizer, clip_processor, 'test', rank, world_size,base_path='/home/pani3/tar_data')
    ...
    total_scores = gaze_score2(model,test_loader,tokenizer,rank)
    if rank==0:

        save_loss_to_file(np.mean(total_scores),"insert path/open_flamingo/open_flamingo/models/review2/gaze_model_semantic.txt")
        print("over")
