...
def fsdp_main(rank, world_size, args):
    ...
    if os.path.isfile(checkpoint_path):
        dist.barrier()
        start_epoch = load_checkpoint_new("insert path/open_flamingo/open_flamingo/models/last_checkpoint.pth",model,optimizer,rank=rank)
    ...
    #validation 
        ...
        save_checkpoint(model, optimizer, scheduler, epoch, "insert path/open_flamingo/open_flamingo/models/last_checkpoint.pth")
