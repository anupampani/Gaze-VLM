...
import torch
import wandb
from data import get_dataset_gaze_eval,get_dataset_gaze,get_small_dataset
...
def fsdp_main(rank, world_size, args):
    ...
    test_dataset_info = get_small_dataset(tokenizer, clip_processor, 'test', rank, world_size,32)
    ...
    if os.path.isfile(checkpoint_path):
        dist.barrier()
        checkpoint = load_checkpoint_eval("insert path/open_flamingo/open_flamingo/models/small_training_base/001_last_checkpoint.pth")
